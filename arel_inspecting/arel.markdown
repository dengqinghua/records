...
return a
```
![AST](https://github.com/dengqinghua/records/blob/master/arel_inspecting/AST.png)
...
INFO: The design comes from [SQL As Understood By SQLite](https://www.sqlite.org/lang_select.html)
  ...
  * select\_statement
  ...
  ![select-stmt](https://github.com/dengqinghua/records/blob/master/arel_inspecting/factored-select-stmt.gif)

  * select\_core

  ![select-core](https://github.com/dengqinghua/records/blob/master/arel_inspecting/select-core.gif)
